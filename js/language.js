...
function outputLanguage() {
	...
	let dateOld = new Date("July 30, 2018 13:00:00");
	let dateFormatted = new Intl.DateTimeFormat(undefined, { weekday: "long", month: "long", day: "numeric", year: "numeric", hour: "numeric", minute: "numeric", second: "numeric", hour12: true, timeZoneName: "long" });
	let rOptions = dateFormatted.resolvedOptions();
	let dateOpt = { weekday: "long", month: "long", day: "numeric", year: "numeric", hour: "numeric", minute: "numeric", second: "numeric", hour12: true, timeZoneName: "long" };
	// language
	...
	// timezone
	let tmpL = dateUsed.getTimezoneOffset()+ ' | ' + dateOld.getTimezoneOffset();
	...
	if (amFF == true) {
		...
		// dtd
		let dtd1 = "", dtd2="";
		let iframeDTD1 = document.getElementById("iframeDTD1");
		...
		// dtd nullprinciple
		let iframeDTD2 = document.getElementById("iframeDTD2");
		...
		let iframeAPPL = document.getElementById("iframeAPPL");
		...
		let nb1 = str2.search("http"); if (nb1 == -1) {nb1 = str2.search("file")}
